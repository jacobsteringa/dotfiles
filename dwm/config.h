...
static const char selbordercolor[]  = "#99CC99";
static const char selbgcolor[]      = "#2d2d2d";
static const char selfgcolor[]      = "#99CC99";
...
static const char *dmenucmd[] = { "dmenu_run", "-p", ">",  "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
static const char *termcmd[]  = { "urxvt", NULL };
static const char *lowervolumecmd[]  = { "amixer", "set", "Master", "2%-", NULL };
static const char *raisevolumecmd[]  = { "amixer", "set", "Master", "2%+", NULL };
